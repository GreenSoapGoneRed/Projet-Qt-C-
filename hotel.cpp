...
bool hotel::ajouterH()
{
    ...
    query.prepare("INSERT INTO hotel(idhotel, nom , adresse , etoiles, coutparnuit ) VALUES ( HABIB.INCREMENT_IDHOTEL.NEXTVAL,:nom , :adresse, :etoiles,:coutparnuit)");
...
bool hotel::supprimer(int idhotel)
{
    QSqlQuery query;
    QString res=QString::number(idhotel);
...
bool hotel::modifier(QString adresse, QString nom, int etoiles, int coutparnuit,int idhotel)
{
    QSqlQuery query;
...
QSqlQueryModel * hotel:: recherche(QString valeur,int etat)
{
    ...
    model->setHeaderData(2, Qt::Horizontal, QObject::tr("id hotel"));
    model->setHeaderData(3, Qt::Horizontal, QObject::tr("etoiles"));
    model->setHeaderData(4, Qt::Horizontal, QObject::tr("coutparnuit"));
    return model;
